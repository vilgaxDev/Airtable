        ...
        <div className="card-body">
          <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select name="tags" multiple={true} value={this.this.state.books} onChange={this.handleInputChange} className="form-control form-control-sm" required>
